...
## Education
**BS-MS in Mathematics (2023-2028)** \
*Indian Institute of Science Education and Research (IISER), Mohali*


- *Relevant Advanced Coursework*: Functional analysis, Fields and Galois Theory, Manifolds, Knots and Braids, Linear Algebraic Groups
- *Foundational Courses*: Group Theory, Rings and Modules, Complex Analysis, Linear Algebra, Measure Theory. Topology
...
Studied the biology of yeast growth on sucrose, glucose, and melibiose alongside mathematical concepts including the Moran process, Distribution of Fitness Effects (DFE), and evolutionary models of cheater–cooperator systems. Developed Python simulations using NumPy, pandas, and Matplotlib to model long-term evolutionary dynamics, introducing mutations and tracking their effects on fitness and related parameters. Computed fitness distributions of generated mutations and investigated the resulting evolutionary dynamics.
...
- Lie bialgebras and their role in quantisation of Poisson-Lie groups
...
- Gold Medal, Homi Bhabha Young Scientist Competition (2019)
...
**Freelance Mathematics Tutor (Feb 2025 - May 2025)** \
Designed individualized learning plans and provided conceptual, derivation-focused mathematics instruction.
