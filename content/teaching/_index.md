...
We started off by learning about basics of set theory and functions and built our way up to calculus. Along the way many other topics such as combinatorics and conic sections were explored. Once a good foundation in mathematics was established, we started with physics - the perspective was to motivate physical ideas using various experiments and use the mathematics we learned as a tool to model reality. Various questions about the nature of the theory were raised to motivate the need for rigor. Detailed syllabus can be viewed [here](static/files/iat_teaching_syllabus.pdf)
